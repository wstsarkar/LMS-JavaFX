...
public class ReturnController implements Initializable {
	...
	public ObservableList<Books> getReturnableBooksList() {
		ObservableList<Books> booksList = FXCollections.observableArrayList();
		if (student != null) {
			booksList.addAll(bookRepository.getReturnableBookList(student.getId()));
		}
		return booksList;
	}
	...
	public void showAvailableBooks() {
		ObservableList<Books> list = getReturnableBooksList();
